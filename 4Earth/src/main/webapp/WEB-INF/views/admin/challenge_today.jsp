...
<div class="container">
	<div class="contents">
		<div class="side-bar is-open">
			...
			<ul>
				<li><a href=""> <i class="material-icons md-16"></i> <span></span>
				</a></li>
				<li><a href=""> <i class="material-icons md-16"></i> <span></span>
				</a></li>
				<li><a href=""> <i class="material-icons md-16"></i> <span></span>
		...
		<section class="content-wrap">
			<div class="page-tit">
				...
				<div class="bread-crumb">
					...
					<a href="#">챌린지</a> <span>오늘의 챌린지</span>
				</div>
			</div>
			...
			<section>
				<div class="board-head">
					<div class="select-wrap">
						...
						</select> <select name="" id="count-select" class="selectbox">
								...
								<c:forEach var="today" items="${ list }" varStatus="vs">
									<tr>
										...
										<td><fmt:formatNumber pattern="##,###"
												value="${ today.chalPoint }" /></td>
										<td><fmt:formatDate value="${ today.startDate }"
												pattern="yyy-MM-dd hh:mm" /></td>
										<td>${ today.chalStatus }</td>
										<td><a href="#popup${ vs.index }"
											class="btn btn-s btn-open-pop">보기</a>
											<div class="layer-popup" id="popup${ vs.index }">
												<div class="layer-inner">
													<div class="pop-head">
														<strong>오늘의 챌린지</strong> <a href="#" class="btn-close-pop"><i
															class="material-icons md-24">close</i></a>
													</div>
													<div class="pop-cont">
														<table id="view-table">
															<colgroup>
															...
															<tbody>
																...
																<tr>
																	...
																	<td><fmt:formatDate value="${ today.startDate }"
																			pattern="yyy-MM-dd hh:mm" /></td>
																	<th>종료일</th>
																	<td><fmt:formatDate value="${ today.endDate }"
																			pattern="yyy-MM-dd hh:mm" /></td>
																</tr>
																<tr>
																	<th colspan="2">사진</th>
																...
																<tr>
																	<td colspan="2"><img id="member-img"
																		src="${ path }/resources/upload/challenge/${today.renamedFilename}" /></td>
										...
										<td>
											<button class="btn btn-s" id="today_update"
												value="${ today.chalNo }">수정</button>
											<button id="delete" name="no" value=${ today.chalNo }
												class="btn btn-s gray">정지</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
			...
			<c:if test="${ !empty list }">
				<div class="paging">
					<!-- 맨 처음으로 -->
					<a class="first" href="${ path }/admin_challenge_today?page=1"></a>

					<!-- 이전 페이지로 -->
					<a class="prev"
						href="${ path }/admin_challenge_today?page=${ pageInfo.prevPage }"></a>
					...
					<c:forEach begin="${ pageInfo.startPage }"
						...
						<c:if test="${ status.current != pageInfo.currentPage }">
							<a
								href="${ path }/admin/challenge_today?page=${ status.current }&count=${ pageInfo.listLimit }">${ status.current }</a>
						</c:if>
					</c:forEach>

					<!-- 다음 페이지로 -->
					<a class="next"
						href="${ path }/admin_challenge_today?page=${ pageInfo.nextPage }"></a>

					<!-- 맨 끝으로 -->
					<a class="last"
						href="${ path }/admin_challenge_today?page=${ pageInfo.maxPage }"></a>
				</div>
			</c:if>
		</section>
