		...
		<section class="content-wrap">
			<div class="page-tit">
				...
				<div class="bread-crumb">
					...
					<a href="${ path }/today_list">에코 챌린지</a> <span>오늘의 챌린지</span>
				</div>
			</div>
							...
							<div class="example">
								...
								<ul>
									<li>
										...
										<strong>
											<i class="material-icons md-22">thumb_up</i>이렇게 찍어주세요!
										</strong>
									...
									<li>
										...
										<strong>
											<i class="material-icons md-22">thumb_down</i>이런 사진은 안 돼요!
										</strong>
						...
						<section class="section">
							...
							<div class="prov-set">
								<form action="${ path }/today_complete?chalNo=${ today.chalNo }" method="post" enctype="multipart/form-data">
									<input type="text" name="chalPoint" value="${ today.chalPoint }" class="blind">
									
									<div class="thumb-img">
										<strong>예시 이미지</strong>
										<img src="${ path }/resources/images/challenge/${ today.renamedFilename }" alt="">
									</div>
