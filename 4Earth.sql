...
-- 컬럼 추가 및 컬럼명(시작일) 수정(220310)
ALTER TABLE CHAL_TODAY ADD END_DATE DATE;
ALTER TABLE CHAL_TODAY ADD CHAL_STATUS CHAR;
ALTER TABLE CHAL_TODAY RENAME COLUMN CHAL_DATE TO START_DATE;
...
-- 오늘의 챌린지 테이블 INSERT
INSERT INTO CHAL_TODAY (CATEGORY, CHAL_NO, CHAL_TITLE, CHAL_CONTENT, CHAL_IMG_PATH, CHAL_POINT, START_DATE)
...
INSERT INTO CHAL_TODAY_MEM (
    NO, MEM_NO, CHAL_NO, CHAL_DATE, CHAL_STATUS, ORIGINAL_FILENAME, RENAMED_FILENAME, CHAL_POINT, CHAL_POINT_STATUS
) VALUES ( SEQ_CHLG_TODAY_MEM.NEXTVAL, 1, 1, SYSDATE, DEFAULT, '', '', 1000, DEFAULT);
...
-- 컬럼 추가 및 컬럼명(시작일) 수정(220310)
ALTER TABLE CHAL_MONTH ADD CHAL_STATUS CHAR;
ALTER TABLE CHAL_MONTH RENAME COLUMN CHAL_DATE TO START_DATE;
ALTER TABLE CHAL_MONTH RENAME COLUMN CHAL_MODIFY_DATE TO END_DATE;

-- 이달의 챌린지 테이블 INSERT
INSERT INTO CHAL_MONTH (
    CATEGORY, CHAL_NO, CHAL_TITLE, CHAL_CONTENT, CHAL_IMG_PATH, CHAL_POINT, CHAL_COUNT, CHAL_DATE, CHAL_MODIFY_DATE
) VALUES ( 2, SEQ_CHLG_TODAY.NEXTVAL, '이달의 챌린지 제목', '이달의 챌린지 내용', '/resources/images/challenge', 5000, 10, DEFAULT, DEFAULT);

INSERT INTO CHAL_MONTH (CATEGORY, CHAL_NO, CHAL_TITLE, CHAL_CONTENT, CHAL_IMG_PATH, CHAL_POINT, CHAL_COUNT, CHAL_DATE, CHAL_MODIFY_DATE ) 
    VALUES (2, SEQ_CHLG_TODAY.NEXTVAL, '이달의 챌린지 제목', '이달의 챌린지 내용', '/resources/images/challenge', 1000, 10, DEFAULT, DEFAULT);
...
BEGIN
    FOR N IN 1..5
    LOOP
        INSERT INTO CHAL_MONTH VALUES(2, SEQ_CHLG_TODAY.NEXTVAL, '이달의 챌린지 제목' || SEQ_CHLG_TODAY.CURRVAL, '이달의 챌린지 내용'  || SEQ_CHLG_TODAY.CURRVAL, '/resources/images/challenge', 2000, 10, DEFAULT, DEFAULT);
    END LOOP;
...
BEGIN
    FOR N IN 1..5
    LOOP
        INSERT INTO CHAL_MONTH VALUES(2, SEQ_CHLG_TODAY.NEXTVAL, '이달의 챌린지 제목' || SEQ_CHLG_TODAY.CURRVAL, '이달의 챌린지 내용'  || SEQ_CHLG_TODAY.CURRVAL, '/resources/images/challenge', 3000, 10, DEFAULT, DEFAULT);
    END LOOP;
...
--SELECT CATEGORY, CHAL_NO, CHAL_TITLE, CHAL_CONTENT, CHAL_IMG_PATH, CHAL_POINT, CHAL_COUNT, CHAL_DATE, CHAL_MODIFY_DATE
--FROM CHAL_MONTH
--ORDER BY CHAL_NO DESC;
...
CREATE TABLE CHAL_MONTH_MEM (
    ...
    RENAMED_FILENAME VARCHAR2(4000),
    CHAL_COUNT NUMBER,
    CHAL_STATUS CHAR DEFAULT 'N' CHECK(CHAL_STATUS IN('Y', 'N')),
    CHAL_POINT NUMBER,
    CHAL_POINT_STATUS CHAR DEFAULT 'N' CHECK(CHAL_POINT_STATUS IN('Y', 'N'))
);
...
COMMENT ON COLUMN CHAL_MONTH_MEM.ORIGINAL_FILENAME IS '원본 파일명';
COMMENT ON COLUMN CHAL_MONTH_MEM.RENAMED_FILENAME IS '수정 파일명';
COMMENT ON COLUMN CHAL_MONTH_MEM.CHAL_COUNT IS '달성 횟수';
...
-- 이달의 챌린지 테이블 시퀀스 생성
CREATE SEQUENCE SEQ_CHLG_MONTH_MEM;

-- 이달의 챌린지 참여 회원 테이블 INSERT
INSERT INTO CHAL_MONTH_MEM (NO, MEM_NO, CHAL_NO, CHAL_DATE, ORIGINAL_FILENAME, RENAMED_FILENAME, CHAL_COUNT, CHAL_STATUS, CHAL_POINT, CHAL_POINT_STATUS)
    VALUES (SEQ_CHLG_MONTH_MEM.NEXTVAL, 1, 1, SYSDATE, '', '', 1, 'Y', 5000, 'N');

INSERT INTO CHAL_MONTH_MEM (NO, MEM_NO, CHAL_NO, CHAL_DATE, ORIGINAL_FILENAME, RENAMED_FILENAME, CHAL_COUNT, CHAL_STATUS, CHAL_POINT, CHAL_POINT_STATUS)
    VALUES (SEQ_CHLG_MONTH_MEM.NEXTVAL, 1, 39, SYSDATE, '', '', 1, 'Y', 5000, 'N');

INSERT INTO CHAL_MONTH_MEM (NO, MEM_NO, CHAL_NO, CHAL_DATE, ORIGINAL_FILENAME, RENAMED_FILENAME, CHAL_COUNT, CHAL_STATUS, CHAL_POINT, CHAL_POINT_STATUS)
    VALUES (SEQ_CHLG_MONTH_MEM.NEXTVAL, 1, 40, SYSDATE, '', '', 1, 'Y', 5000, 'N');
...
DROP SEQUENCE SEQ_CHLG_MONTH_MEM;
DROP TABLE CHAL_MONTH_MEM;

-- 이달의 챌린지 참여 회원 목록 조회
SELECT * FROM CHAL_MONTH_MEM;

--SELECT M.NO, M.MEM_NO, M.CHAL_NO, T.CHAL_TITLE, M.CHAL_DATE, M.ORIGINAL_FILENAME, M.RENAMED_FILENAME, M.CHAL_COUNT, M.CHAL_STATUS, M.CHAL_POINT, M.CHAL_POINT_STATUS
...
--FROM CHAL_MONTH_MEM M
--JOIN CHAL_MONTH T ON (M.CHAL_NO = T.CHAL_NO)
--WHERE M.CHAL_NO = 70 AND M.MEM_NO = 2
--ORDER BY NO DESC;

-- 참여 중인 사용자 조회
--SELECT DISTINCT M.MODIFY_IMG_NAME, M.ID
--FROM MEMBER M
--JOIN CHAL_MONTH_MEM C ON (M.NO = C.MEM_NO)
--WHERE CHAL_NO = 70 AND MEM_NO != 2;

-- 참여 중인 사용자 갯수 조회
--SELECT COUNT (DISTINCT MEM_NO)
--FROM MEMBER M
--JOIN CHAL_MONTH_MEM C ON (M.NO = C.MEM_NO)
--WHERE CHAL_NO = 70 AND MEM_NO != 6;

-- 참여 중인 사용자 테스트용 회원 INSERT
...
--VALUES (SEQ_UNO.NEXTVAL,  'minyeongpark',  '1234',  DEFAULT,  '박민영',  '01000000000',  'potatoking1@naver.com',  '경기도 용인시 기흥구', DEFAULT, DEFAULT, NULL, NULL, DEFAULT, DEFAULT);
--INSERT INTO MEMBER (NO,  ID,  PASSWORD,  MEMBER_TYPE, NAME,  PHONE,  EMAIL,  ADDRESS,  PLATFORM_TYPE,  STATUS,  IMG_NAME,  MODIFY_IMG_NAME,  ENROLL_DATE,  MODIFY_DATE) 
--VALUES (SEQ_UNO.NEXTVAL,  'ejchoi',  '1234',  DEFAULT,  '최어진',  '01000000000',  'potatoking2@naver.com',  '경기도 용인시 기흥구', DEFAULT, DEFAULT, NULL, NULL, DEFAULT, DEFAULT);
--INSERT INTO MEMBER (NO,  ID,  PASSWORD,  MEMBER_TYPE, NAME,  PHONE,  EMAIL,  ADDRESS,  PLATFORM_TYPE,  STATUS,  IMG_NAME,  MODIFY_IMG_NAME,  ENROLL_DATE,  MODIFY_DATE) 
--VALUES (SEQ_UNO.NEXTVAL,  'jalee',  '1234',  DEFAULT,  '이진아',  '01000000000',  'potatoking3@naver.com',  '경기도 용인시 기흥구', DEFAULT, DEFAULT, NULL, NULL, DEFAULT, DEFAULT);
--INSERT INTO MEMBER (NO,  ID,  PASSWORD,  MEMBER_TYPE, NAME,  PHONE,  EMAIL,  ADDRESS,  PLATFORM_TYPE,  STATUS,  IMG_NAME,  MODIFY_IMG_NAME,  ENROLL_DATE,  MODIFY_DATE) 
--VALUES (SEQ_UNO.NEXTVAL,  'dwryu',  '1234',  DEFAULT,  '류동우',  '01000000000',  'potatoking4@naver.com',  '경기도 용인시 기흥구', DEFAULT, DEFAULT, NULL, NULL, DEFAULT, DEFAULT);
--INSERT INTO MEMBER (NO,  ID,  PASSWORD,  MEMBER_TYPE, NAME,  PHONE,  EMAIL,  ADDRESS,  PLATFORM_TYPE,  STATUS,  IMG_NAME,  MODIFY_IMG_NAME,  ENROLL_DATE,  MODIFY_DATE) 
--VALUES (SEQ_UNO.NEXTVAL,  'kwcho',  '1234',  DEFAULT,  '조관우',  '01000000000',  'potatoking5@naver.com',  '경기도 용인시 기흥구', DEFAULT, DEFAULT, NULL, NULL, DEFAULT, DEFAULT);

-- 이달의 챌린지 참여 횟수 조회
--SELECT CHAL_COUNT
--FROM CHAL_MONTH_MEM
--WHERE MEM_NO = 2 AND CHAL_NO = 70;
...
CREATE TABLE CHAL_REPLY (
    ...
    MODIFY_DATE DATE DEFAULT SYSDATE,
    REPLY_STATUS CHAR DEFAULT 'Y' CHECK(REPLY_STATUS IN('Y', 'N'))
);
...
COMMENT ON COLUMN CHAL_REPLY.REPLY_STATUS IS '게시 상태';

-- 댓글 테이블 시퀀스 생성
CREATE SEQUENCE SEQ_CHAL_REPLY;

-- 댓글 테이블 INSERT
INSERT INTO CHAL_REPLY (REPLY_NO, CHAL_NO, CONTENT, REPLY_DATE, MODIFY_DATE, REPLY_STATUS)
    VALUES (SEQ_CHAL_REPLY.NEXTVAL, 70, '댓글 잘 되나??', SYSDATE, NULL, DEFAULT);

-- 댓글 테이블 삭제
DROP SEQUENCE SEQ_CHAL_REPLY;
DROP TABLE CHAL_REPLY;

SELECT * FROM CHAL_REPLY;
...
-- 대댓글 테이블 INSERT
INSERT INTO CHAL_NESTED_REPLY (REPLY_NO, CHAL_NO, CONTENT, REPLY_DATE, MODIFY_DATE, NESTED_REPLY_STATUS)
    VALUES (SEQ_CHAL_NESTED_REPLY.NEXTVAL, 70, '대대대대대댓글 잘 되나??', SYSDATE, NULL, DEFAULT);

-- 대댓글 테이블 삭제
DROP SEQUENCE SEQ_CHAL_NESTED_REPLY;
DROP TABLE CHAL_NESTED_REPLY;

SELECT * FROM CHAL_NESTED_REPLY;
...
-- 포인트 테이블 생성
CREATE TABLE POINT (
    POINT_NO NUMBER CONSTRAINT CHAL_POINT_NO_PK PRIMARY KEY,
    MEM_NO NUMBER,
...
-- 포인트 테이블 INSERT
INSERT INTO POINT (POINT_NO, MEM_NO, SAVE_DATE, CONTENT, POINT, DISAPEAR_DATE)
    VALUES (SEQ_POINT.NEXTVAL, 2, DEFAULT, '오늘의 챌린지 달성', 5000, NULL);
...
CREATE TABLE POINT_DETAIL (
    POINT_NO NUMBER CONSTRAINT CHAL_POINT_DETAIL_NO_PK PRIMARY KEY,
    MEM_NO NUMBER,
    CONTENT VARCHAR2(4000),
    SPEND_POINT NUMBER,
