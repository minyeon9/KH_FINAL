...
ALTER TABLE CHAL_MONTH_MEM RENAME COLUMN CHAL_COUNT TO MY_COUNT;
...
CREATE TABLE CHAL_REPLY (
    ...
    MEM_NO CONSTRAINT RP_MEMBER_NO_FK REFERENCES MEMBER(NO),
    CHAL_NO NUMBER,
...
CREATE TABLE CHAL_NESTED_REPLY (
    ...
    MEM_NO NUMBER CONSTRAINT NR_MEMBER_NO_FK REFERENCES MEMBER(NO),
    CHAL_NO NUMBER,
    CONTENT VARCHAR2(4000),
    REPLY_DATE DATE DEFAULT SYSDATE,
    MODIFY_DATE DATE DEFAULT SYSDATE,
