...
INSERT INTO QNA VALUES(SEQ_QNA_NO.NEXTVAL, '2', '주문내역이 조회되지 않습니다.', '0201', '주문내역 확인 좀 부탁드려요!!', DEFAULT, NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO QNA VALUES(SEQ_QNA_NO.NEXTVAL, '3', '입금했어요~!', '0201', '123', DEFAULT, NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO QNA VALUES(SEQ_QNA_NO.NEXTVAL, '43', '챌리지 완료 했는데 이상해요', '0103', '123', DEFAULT, NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO QNA VALUES(SEQ_QNA_NO.NEXTVAL, '41', '회원정보가 없다고 나오네요', '0303', '123', DEFAULT, NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO QNA VALUES(SEQ_QNA_NO.NEXTVAL, '42', '세금계산서 발행 요청', '0401', '123', DEFAULT, NULL, NULL, DEFAULT, DEFAULT, DEFAULT);